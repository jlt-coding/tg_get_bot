...
class Telegramuser():
    def __init__(self, user_name, user_id, user_mute=0, user_gold=0, user_silver=0, user_gold_rec=0, user_silver_rec=0):
        self.name = user_name
        self.id = user_id
        self.mute = user_mute
        self.gold = user_gold
        self.silver = user_silver
        self.gold_received = user_gold_rec
        self.silver_received = user_silver_rec
